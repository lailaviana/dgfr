...
```
If you prefer, you can utilize a sample dataset included in the package named `fasta`, which comprises 75 protein sequences. In this instance, I will employ the complete set of proteins `tcmuc_fasta`.
