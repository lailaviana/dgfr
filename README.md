...
the mean/meadian similarity inside each cluster.
...
``` r
score_file <- dgfr::get_alignment_score(fasta = fasta_file,
                                        type = "prot",
...
7.  Finally, you can access the mean/median similarity among each
